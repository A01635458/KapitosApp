...
struct AppColors {
    ...
    static let backgroundDark  = Color(hex: "#1A1A1A")   // gris/café muy suave
    static let cardDark        = Color(hex: "#242424")   // un poco más claro que bg
    static let accentDark      = Color(hex: "#D0BFA3")   // beige-dorado suave
    static let textDark        = Color.white             // FULL WHITE
}
